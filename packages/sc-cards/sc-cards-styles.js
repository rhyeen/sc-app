...
export const CARDS = {
  ...
  MINION_COVER: {
    ...
    PADDING: css`8px`,
    BORDER_RADIUS: CARDS_MINION_BORDER_RADIUS,
    PLACE_MINION_BORDER: css`
      ${CARDS_MINION_BORDER_SIZE} dashed #8D6E63
    `,
    CAST_TARGET_MINION_BORDER: css`
      ${CARDS_MINION_BORDER_SIZE} dashed #7E57C2
    `,
    ATTACK_MINION_BORDER: css`
      ${CARDS_MINION_BORDER_SIZE} dashed #E53935
    `,
  ...
  FULL: {
    ...
    BORDER: css`
      ${CARDS_FULL_BORDER_SIZE} solid #000
    `,
